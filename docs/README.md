...
Run `npm start` to see NextWrk.com at `localhost:3000`
...
The [`app/`](../../../tree/master/app) directory contains NextWrk.com's application code, including CSS,
...
The boilerplate bundles all your clientside scripts and chunks them into several files using
code splitting where possible. It then automatically optimizes your code when
