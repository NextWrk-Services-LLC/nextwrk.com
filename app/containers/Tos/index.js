      ...
      <div style={{ padding: '0px 5px' }}>
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to NextWrk Services LLC,
            2033 Melodi Lane, Cumming GA 30041.
          </li>
          <li>
          ...
          <li>
            ...
            Terms and Terms and Conditions agreement as been created with the
            help of{' '}
          ...
          <li>
            <strong>Website</strong> refers to NextWrk, accessible from
            nextwrk.com
          </li>{' '}
          <li>
        ...
        <ul>
          <li>By email: contact@nextwrk.com</li>
          <li>
            By visiting this page on our website: nextwrk.com/terms-of-service
          </li>
